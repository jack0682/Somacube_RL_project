...
bool doosan_somacube_rl__msg__safety_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_somacube_rl.msg._safety_event.SafetyEvent", full_classname_dest, 48) == 0);
  }
  doosan_somacube_rl__msg__SafetyEvent * ros_message = _ros_message;
  {  // type
  ...
  {  // severity
    ...
    ros_message->severity = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // stamp
...
PyObject * doosan_somacube_rl__msg__safety_event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_somacube_rl.msg._safety_event");
  ...
  {  // severity
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->severity);
    {
