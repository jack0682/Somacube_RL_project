...
#include "doosan_somacube_rl/msg/detail/register_quality__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const doosan_somacube_rl::msg::RegisterQuality & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_somacube_rl::msg::RegisterQuality & ros_message)
{
  // Member: mean_point2plane_m
  cdr >> ros_message.mean_point2plane_m;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_doosan_somacube_rl
max_serialized_size_RegisterQuality(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_somacube_rl::msg::RegisterQuality;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_somacube_rl::msg::RegisterQuality *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doosan_somacube_rl::msg::RegisterQuality *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RegisterQuality__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const doosan_somacube_rl::msg::RegisterQuality *>(
...
static size_t _RegisterQuality__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RegisterQuality(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RegisterQuality__callbacks = {
...
static rosidl_message_type_support_t _RegisterQuality__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RegisterQuality__callbacks,
...
get_message_type_support_handle<doosan_somacube_rl::msg::RegisterQuality>()
{
  return &doosan_somacube_rl::msg::typesupport_fastrtps_cpp::_RegisterQuality__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_somacube_rl, msg, RegisterQuality)() {
  return &doosan_somacube_rl::msg::typesupport_fastrtps_cpp::_RegisterQuality__handle;
}
