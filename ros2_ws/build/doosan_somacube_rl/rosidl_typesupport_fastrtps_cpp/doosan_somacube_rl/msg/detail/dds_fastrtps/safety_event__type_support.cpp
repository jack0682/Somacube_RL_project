...
#include "doosan_somacube_rl/msg/detail/safety_event__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_somacube_rl::msg::SafetyEvent;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_somacube_rl::msg::SafetyEvent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doosan_somacube_rl::msg::SafetyEvent *>(
    untyped_ros_message);
...
{
  return &doosan_somacube_rl::msg::typesupport_fastrtps_cpp::_SafetyEvent__handle;
}
