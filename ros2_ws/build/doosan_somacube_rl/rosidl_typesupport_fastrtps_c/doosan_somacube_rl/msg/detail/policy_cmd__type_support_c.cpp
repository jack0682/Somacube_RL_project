...
#include "doosan_somacube_rl/msg/detail/policy_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _PolicyCmd__ros_msg_type = doosan_somacube_rl__msg__PolicyCmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PolicyCmd__ros_msg_type * ros_message = static_cast<const _PolicyCmd__ros_msg_type *>(untyped_ros_message);
  // Field name: dx
  {
    cdr << ros_message->dx;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _PolicyCmd__ros_msg_type * ros_message = static_cast<_PolicyCmd__ros_msg_type *>(untyped_ros_message);
  // Field name: dx
  {
    cdr >> ros_message->dx;
  }
...
size_t get_serialized_size_doosan_somacube_rl__msg__PolicyCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PolicyCmd__ros_msg_type * ros_message = static_cast<const _PolicyCmd__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PolicyCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_somacube_rl__msg__PolicyCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_somacube_rl
size_t max_serialized_size_doosan_somacube_rl__msg__PolicyCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_somacube_rl__msg__PolicyCmd;
    is_plain =
      (
...
static size_t _PolicyCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_somacube_rl__msg__PolicyCmd(
...
static message_type_support_callbacks_t __callbacks_PolicyCmd = {
...
static rosidl_message_type_support_t _PolicyCmd__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PolicyCmd,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_somacube_rl, msg, PolicyCmd)() {
  return &_PolicyCmd__type_support;
}
