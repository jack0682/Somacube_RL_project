...
static const _RegisterQuality_type_support_symbol_names_t _RegisterQuality_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_somacube_rl, msg, RegisterQuality)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_somacube_rl, msg, RegisterQuality)),
  }
};
...
{
  return &::doosan_somacube_rl::msg::rosidl_typesupport_cpp::RegisterQuality_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, doosan_somacube_rl, msg, RegisterQuality)() {
  return get_message_type_support_handle<doosan_somacube_rl::msg::RegisterQuality>();
}
