...
static const _PolicyCmd_type_support_symbol_names_t _PolicyCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_somacube_rl, msg, PolicyCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_somacube_rl, msg, PolicyCmd)),
  }
};
...
{
  return &::doosan_somacube_rl::msg::rosidl_typesupport_cpp::PolicyCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, doosan_somacube_rl, msg, PolicyCmd)() {
  return get_message_type_support_handle<doosan_somacube_rl::msg::PolicyCmd>();
}
