...
class RobotStateRt(metaclass=Metaclass_RobotStateRt):
    ...
    def __eq__(self, other):
        ...
        if self.time_stamp != other.time_stamp:
            return False
        if all(self.actual_joint_position != other.actual_joint_position):
            return False
        if all(self.actual_joint_position_abs != other.actual_joint_position_abs):
            return False
        if all(self.actual_joint_velocity != other.actual_joint_velocity):
            return False
        if all(self.actual_joint_velocity_abs != other.actual_joint_velocity_abs):
            return False
        if all(self.actual_tcp_position != other.actual_tcp_position):
            return False
        if all(self.actual_tcp_velocity != other.actual_tcp_velocity):
            return False
        if all(self.actual_flange_position != other.actual_flange_position):
            return False
        if all(self.actual_flange_velocity != other.actual_flange_velocity):
            return False
        if all(self.actual_motor_torque != other.actual_motor_torque):
            return False
        if all(self.actual_joint_torque != other.actual_joint_torque):
            return False
        if all(self.raw_joint_torque != other.raw_joint_torque):
            return False
        if all(self.raw_force_torque != other.raw_force_torque):
            return False
        if all(self.external_joint_torque != other.external_joint_torque):
            return False
        if all(self.external_tcp_force != other.external_tcp_force):
            return False
        if all(self.target_joint_position != other.target_joint_position):
            return False
        if all(self.target_joint_velocity != other.target_joint_velocity):
            return False
        if all(self.target_joint_acceleration != other.target_joint_acceleration):
            return False
        if all(self.target_motor_torque != other.target_motor_torque):
            return False
        if all(self.target_tcp_position != other.target_tcp_position):
            return False
        if all(self.target_tcp_velocity != other.target_tcp_velocity):
            return False
        if self.jacobian_matrix != other.jacobian_matrix:
            return False
        if all(self.gravity_torque != other.gravity_torque):
            return False
        ...
        if self.controller_digital_output != other.controller_digital_output:
            return False
        if all(self.controller_analog_input_type != other.controller_analog_input_type):
            return False
        if all(self.controller_analog_input != other.controller_analog_input):
            return False
        if all(self.controller_analog_output_type != other.controller_analog_output_type):
            return False
        if all(self.controller_analog_output != other.controller_analog_output):
            return False
        if self.flange_digital_input != other.flange_digital_input:
            return False
        if self.flange_digital_output != other.flange_digital_output:
            return False
        if all(self.flange_analog_input != other.flange_analog_input):
            return False
        if all(self.external_encoder_strobe_count != other.external_encoder_strobe_count):
            return False
        if all(self.external_encoder_count != other.external_encoder_count):
            return False
        if all(self.goal_joint_position != other.goal_joint_position):
            return False
        if all(self.goal_tcp_position != other.goal_tcp_position):
            return False
        ...
        if self.control_mode != other.control_mode:
            return False
        if all(self.reserved != other.reserved):
            return False
        return True
