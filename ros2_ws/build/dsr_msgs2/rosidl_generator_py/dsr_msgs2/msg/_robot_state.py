...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    def __eq__(self, other):
        ...
        if self.actual_space != other.actual_space:
            return False
        if all(self.current_posj != other.current_posj):
            return False
        if all(self.current_velj != other.current_velj):
            return False
        if all(self.joint_abs != other.joint_abs):
            return False
        if all(self.joint_err != other.joint_err):
            return False
        if all(self.target_posj != other.target_posj):
            return False
        if all(self.target_velj != other.target_velj):
            return False
        if all(self.current_posx != other.current_posx):
            return False
        if all(self.current_tool_posx != other.current_tool_posx):
            return False
        if all(self.current_velx != other.current_velx):
            return False
        if all(self.task_err != other.task_err):
            return False
        if all(self.target_velx != other.target_velx):
            return False
        if all(self.target_posx != other.target_posx):
            return False
        if all(self.dynamic_tor != other.dynamic_tor):
            return False
        if all(self.actual_jts != other.actual_jts):
            return False
        if all(self.actual_ejt != other.actual_ejt):
            return False
        if all(self.actual_ett != other.actual_ett):
            return False
        if all(self.actual_bk != other.actual_bk):
            return False
        if all(self.actual_mc != other.actual_mc):
            return False
        if all(self.actual_mt != other.actual_mt):
            return False
        if self.solution_space != other.solution_space:
            return False
        if self.sync_time != other.sync_time:
            return False
        if all(self.actual_bt != other.actual_bt):
            return False
        if self.rotation_matrix != other.rotation_matrix:
            return False
        if all(self.ctrlbox_digital_input != other.ctrlbox_digital_input):
            return False
        if all(self.ctrlbox_digital_output != other.ctrlbox_digital_output):
            return False
        if all(self.flange_digital_input != other.flange_digital_input):
            return False
        if all(self.flange_digital_output != other.flange_digital_output):
            return False
        ...
        if self.disconnected != other.disconnected:
            return False
        if all(self.f_actual_w2b != other.f_actual_w2b):
            return False
        if self.f_current_pos_world != other.f_current_pos_world:
            return False
        if all(self.f_current_vel_world != other.f_current_vel_world):
            return False
        if all(self.f_world_ext_target_torque != other.f_world_ext_target_torque):
            return False
        if all(self.f_target_pos_world != other.f_target_pos_world):
            return False
        if all(self.f_target_vel_world != other.f_target_vel_world):
            return False
        ...
        if self.f_current_pos_user != other.f_current_pos_user:
            return False
        if all(self.f_current_vel_user != other.f_current_vel_user):
            return False
        if all(self.f_user_ext_task_torque != other.f_user_ext_task_torque):
            return False
        if all(self.f_target_pos_user != other.f_target_pos_user):
            return False
        if all(self.f_target_vel_user != other.f_target_vel_user):
            return False
        if self.f_rotation_matrix_user != other.f_rotation_matrix_user:
            return False
        if all(self.f_actual_analog_input != other.f_actual_analog_input):
            return False
        if self.b_actual_switch_input != other.b_actual_switch_input:
            return False
        if self.b_actual_safety_input != other.b_actual_safety_input:
            return False
        if all(self.i_actual_analog_input_type != other.i_actual_analog_input_type):
            return False
        if all(self.f_target_analog_output != other.f_target_analog_output):
            return False
        if all(self.i_target_analog_output_type != other.i_target_analog_output_type):
            return False
        if self.b_actual_encorder_strove_signal != other.b_actual_encorder_strove_signal:
            return False
        if all(self.i_actual_encorder_raw_data != other.i_actual_encorder_raw_data):
            return False
