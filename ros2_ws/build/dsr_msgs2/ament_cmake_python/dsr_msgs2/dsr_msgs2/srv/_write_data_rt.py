...
class WriteDataRt_Request(metaclass=Metaclass_WriteDataRt_Request):
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if all(self.external_force_torque != other.external_force_torque):
            return False
        if self.external_digital_input != other.external_digital_input:
            return False
        if self.external_digital_output != other.external_digital_output:
            return False
        if all(self.external_analog_input != other.external_analog_input):
            return False
        if all(self.external_analog_output != other.external_analog_output):
            return False
        return True
